...
const mockUsers: SystemUser[] = [
  {
    ...
    permissions: ["manage_schemes", "manage_users", "view_analytics"],
  ...
  },
  {
    ...
    phone: "+91-9876543211",
    isActive: true,
    lastLogin: "2024-01-25 10:15 AM",
    permissions: ["process_applications", "view_citizens"],
    createdAt: "2024-01-01",
  },
  {
    id: "3",
  ...
  {
    id: "4",
    email: "sneha.patel@gramsathi.gov.in",
    name: "Sneha Patel",
    role: "officer",
    department: "Grievance Cell",
    phone: "+91-9876543213",
    isActive: true,
    lastLogin: "2024-01-24 02:30 PM",
    permissions: ["manage_grievances"],
    createdAt: "2024-01-05",
  },
  {
    id: "5",
    email: "vikram.singh@gramsathi.gov.in",
    name: "Vikram Singh",
    role: "officer",
    ...
    permissions: ["process_applications", "view_citizens", "manage_grievances"],
    createdAt: "2024-01-03",
  },
  {
    id: "6",
    email: "anita.desa@gramsathi.gov.in",
    name: "Anita Desai",
    role: "admin",
    ...
    permissions: ["manage_schemes", "view_analytics"],
        ...
        <GramTable
          columns={[
            ...
            },
            {
              id: "department",
              label: "Department",
              render: (row: SystemUser) => row.department,
            },
            {
              id: "phone",
              label: "Phone",
              render: (row: SystemUser) => row.phone,
            },
            {
              id: "lastLogin",
              label: "Last Login",
              render: (row: SystemUser) => row.lastLogin || "Never",
              sortable: true,
            },
            {
              id: "status",
