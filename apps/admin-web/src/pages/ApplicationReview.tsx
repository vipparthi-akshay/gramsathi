...
const mockApplication = {
  ...
  timeline: [
    ...
    {
      action: "Land Records Verified",
      date: "2024-01-16 10:18 AM",
      by: "AI System",
    },
      ...
      <Box sx={{ display: "flex", alignItems: "center", gap: 1, mb: 3 }}>
        ...
        <Box sx={{ flex: 1 }}>
          ...
          <Typography variant="body2" color="text.secondary">
            {id} • Submitted on {mockApplication.submittedAt}
          </Typography>
        </Box>
      </Box>
              ...
              <Grid container spacing={2}>
                ...
                <Grid item xs={6} sm={3}>
                  ...
                  <Typography variant="body2">
                    {mockApplication.citizen.aadhaar}
                  </Typography>
                </Grid>
                <Grid item xs={6} sm={3}>
                  <Typography variant="caption" color="text.secondary">
                  ...
                  <Chip
                    label={
                      mockApplication.citizen.isVerified
                        ? "Verified"
                        : "Unverified"
                    }
                    size="small"
                    color={
                      mockApplication.citizen.isVerified ? "success" : "warning"
                    }
                  />
                </Grid>
                <Grid item xs={6}>
                  ...
                  <Typography variant="body2">
                    {mockApplication.citizen.age} years /{" "}
                    {mockApplication.citizen.gender}
                  </Typography>
                </Grid>
                <Grid item xs={12}>
                  <Typography variant="caption" color="text.secondary">
                  ...
                  <Typography variant="body2">
                    {mockApplication.citizen.address}
                  </Typography>
                </Grid>
              </Grid>
            </CardContent>
          ...
          <Card sx={{ mb: 2.5 }}>
            <CardContent>
              ...
              <Box sx={{ mt: 1 }}>
                ...
                >
                  Category: {mockApplication.scheme.category}
                </Typography>
                <Typography
                  variant="caption"
                  display="block"
                  color="text.secondary"
                >
                  Department: {mockApplication.scheme.department}
                </Typography>
                <Typography
                  variant="caption"
                  display="block"
                  color="text.secondary"
                >
                  Benefit: {mockApplication.scheme.budget}
                </Typography>
              </Box>
            </CardContent>
          </Card>
