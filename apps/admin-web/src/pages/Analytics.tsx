      ...
      >
        <Box>
          ...
          <Typography variant="body2" color="text.secondary">
            Compliance and impact metrics for all schemes
          </Typography>
        </Box>
                ...
                >
                  ...
                  >
                    <span
                      ...
                      style={{ color: metric.color, fontSize: 22 }}
                    >
                      {metric.icon}
                    </span>
                  </Box>
