            ...
            <CardContent>
              ...
              <Box sx={{ display: "flex", flexDirection: "column", gap: 1 }}>
                ...
                <FormControlLabel
                  control={
                    <Switch
                      checked={notifications.grievanceUpdates}
                      onChange={(e) =>
                        setNotifications({
                          ...notifications,
                          grievanceUpdates: e.target.checked,
                        })
                      }
                    />
                  }
              ...
              <Grid container spacing={2}>
                ...
                <Grid item xs={6}>
                  <TextField
                    ...
                    onChange={(e) =>
                      setApiConfig({ ...apiConfig, timeout: e.target.value })
                    }
                  />
                </Grid>
                <Grid item xs={6}>
                  <TextField
                    ...
                    onChange={(e) =>
                      setApiConfig({ ...apiConfig, retryCount: e.target.value })
                    }
                  />
                </Grid>
              </Grid>
              ...
              <CardContent>
                ...
                <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
                  ...
                  <FormControlLabel
                    ...
                    label="Enable AI Auto-Approvals"
                  />
                  <FormControlLabel
                    control={<Switch defaultChecked />}
