...
const mockSchemes: Scheme[] = [
  ...
  {
    id: "3",
    name: "Shiksha Protsahan",
    nameHi: "शिक्षा प्रोत्साहन",
  ...
  {
    id: "4",
    name: "Digital Gram Yojana",
    nameHi: "डिजिटल ग्राम योजना",
  ...
  {
    id: "5",
    name: "Swasthya Raksha",
    nameHi: "स्वास्थ्य रक्षा",
  ...
  },
  {
    ...
    department: "Ministry of Women & Child",
...
export default function Schemes() {
  ...
  const handleToggleActive = (scheme: Scheme) => {
    setSchemes((prev) =>
      prev.map((s) =>
        s.id === scheme.id ? { ...s, isActive: !s.isActive } : s,
      ),
    );
  };
        ...
        <GramTable
          columns={[
            ...
            },
            {
              id: "department",
              label: "Department",
              render: (row: Scheme) => row.department,
            },
            {
              id: "applicants",
              label: "Applicants",
              render: (row: Scheme) => row.totalApplicants.toLocaleString(),
              sortable: true,
            },
            {
              id: "budget",
              label: "Budget",
              render: (row: Scheme) =>
                `₹${(row.budget / 10000000).toFixed(1)}Cr`,
              sortable: true,
            },
            {
              id: "status",
          ...
          actions={(row: Scheme) => (
            <Box sx={{ display: "flex", gap: 0.5 }}>
              <Tooltip title="Edit">
                <IconButton
                  size="small"
                  onClick={() => navigate(`/schemes/${row.id}/edit`)}
                >
