...
function renderRoutes(routeList: RouteConfig[]) {
  return routeList.map((route) => {
    if (route.children) {
      return (
        <Route key={route.path} path={route.path} element={<ProtectedRoute roles={route.roles}>{route.element || <DashboardLayout />}</ProtectedRoute>}>
...
export default function App() {
  return (
    <Routes>
      ...
      <Route path="/" element={<ProtectedRoute roles={['officer', 'admin', 'super_admin']}><DashboardLayout /></ProtectedRoute>}>
        ...
        <Route path="citizens/:id" element={
          <Suspense fallback={<LoadingFallback />}>
            <CitizenDetailPage />
          </Suspense>
        } />
