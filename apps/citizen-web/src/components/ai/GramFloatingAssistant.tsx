  ...
  useEffect(() => {
    if (messages.length === 0) {
      const welcome: Message = {
        id: 'welcome',
        role: 'assistant',
        content: 'Namaste! I am GramBot, your AI assistant. Ask me about government schemes, applications, or documents!',
        timestamp: Date.now(),
        language: 'en',
        type: 'text',
      };
            ...
            <Box sx={{ p: 1.5, borderTop: '1px solid', borderColor: 'divider' }}>
              <Box sx={{ display: 'flex', gap: 1, alignItems: 'flex-end' }}>
                <TextField
                  ...
                  InputProps={{
                    startAdornment: (
                      <IconButton size="small" sx={{ mr: 0.5 }} aria-label="Voice input">
        ...
        >
          ...
          >
            {open ? (
              ...
              <AutoAwesomeIcon sx={{ animation: 'pulse-glow 2s ease-in-out infinite' }} />
            )}
          </Fab>
        </Badge>
      </motion.div>
