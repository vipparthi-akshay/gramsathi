...
const notifications = [
  {
    ...
    message: "Your PM Kisan application is now under review",
    type: "application",
    date: "Today",
    read: false,
  ...
  },
  {
    ...
    message: "PM Awas Yojana deadline is in 7 days",
    type: "deadline",
    date: "Today",
    read: false,
  ...
  },
  {
    ...
    message: "New solar pump subsidy scheme for farmers",
    type: "scheme",
    date: "2 days ago",
    read: true,
  ...
  },
  {
    ...
    message: "Your water supply complaint has been escalated",
    type: "grievance",
    date: "3 days ago",
    read: true,
    icon: <CampaignIcon color="warning" />,
