...
const docs: DocItem[] = [
  { id: '1', name: 'Aadhaar Card', nameLocal: 'आधार कार्ड', status: 'verified', icon: <BadgeIcon /> },
  { id: '2', name: 'PAN Card', nameLocal: 'पैन कार्ड', status: 'verified', icon: <CreditCardIcon /> },
  { id: '3', name: 'Bank Passbook', nameLocal: 'बैंक पासबुक', status: 'pending', icon: <AccountBalanceIcon /> },
  { id: '4', name: 'Income Certificate', nameLocal: 'आय प्रमाण पत्र', status: 'pending', icon: <ReceiptIcon /> },
  { id: '5', name: 'Domicile Certificate', nameLocal: 'अधिवास प्रमाण पत्र', status: 'rejected', icon: <ReceiptIcon /> },
];
        ...
        {docs.map((doc) => (
          ...
          >
            <CardContent sx={{ display: 'flex', alignItems: 'center', gap: 2, py: 1.5, '&:last-child': { pb: 1.5 } }}>
              <Box sx={{ color: 'primary.main', display: 'flex' }}>{doc.icon}</Box>
              <Box sx={{ flex: 1 }}>
