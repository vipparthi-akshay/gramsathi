        ...
        {step === 1 && file && (
          <Box>
            ...
            <GramDocumentPreview
              ...
              documentType={docTypes.find((d) => d.value === docType)?.label || ''}
              status="needs_review"
              fields={[
          ...
          <Card sx={{ borderRadius: 3, textAlign: 'center', py: 4 }}>
            <CardContent>
              ...
              <Typography variant="body1" color="text.secondary" sx={{ mb: 3 }}>
                Your document has been submitted for verification. This usually takes 1-2 business days.
              </Typography>
              <GramButton variant="primary" onClick={() => router.push('/documents')}>
                Go to Documents
              </GramButton>
            </CardContent>
          </Card>
