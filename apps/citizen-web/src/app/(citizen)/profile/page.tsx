      ...
      <Container maxWidth="sm" sx={{ px: 2, pt: 3 }}>
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12}>
                <TextField
                  fullWidth
                  label="Address"
                  defaultValue="Village Palampur, District Kangra, Himachal Pradesh 176061"
                  variant="outlined"
                  size="small"
                  multiline
                  rows={2}
        ...
        >
          ...
          <AccordionDetails sx={{ px: 3, pb: 3, pt: 0 }}>
            ...
            <List sx={{ p: 0 }}>
              <ListItemButton
                sx={{ borderRadius: 2, mb: 1, bgcolor: "background.default" }}
              >
                <Avatar
                  sx={{ width: 40, height: 40, mr: 2, bgcolor: "info.main" }}
                >
                  S
                </Avatar>
              ...
              <ListItemButton
                sx={{ borderRadius: 2, mb: 2, bgcolor: "background.default" }}
              >
                <Avatar
                  sx={{ width: 40, height: 40, mr: 2, bgcolor: "warning.main" }}
                >
                  A
                </Avatar>
                <ListItemText
                  primary="Arjun Kumar"
                  secondary="Son • 18 years"
                />
                <Button size="small">View</Button>
              </ListItemButton>
              <Button
          ...
          <CardContent sx={{ p: 3 }}>
            ...
            >
              <Box>
                ...
                <Typography variant="body2" color="text.secondary">
                  Toggle high-contrast dark theme
                </Typography>
              </Box>
              ...
              {[
                {
                  ...
                  desc: "Enhanced visibility for visually impaired",
                },
                {
                  key: "largeText",
                  label: "Large Text Mode",
                  desc: "Force large UI elements across app",
                },
                {
                  key: "voiceOnly",
                  label: "Voice Navigation",
                  desc: "Enable voice-guided interactions",
                },
              ].map((item) => (
                <Box
                  key={item.key}
                ...
                >
                  ...
                  <Switch
                    ...
                    onChange={() =>
                      setAccessibilityMode(
                        accessibilityMode === item.key
                          ? "normal"
                          : (item.key as AccessibilityMode),
                      )
                    }
                  />
                </Box>
          ...
          <CardContent sx={{ p: 0 }}>
            <List sx={{ p: 0 }}>
              <ListItemButton sx={{ p: 3 }}>
                <ListItemIcon>
                  <LinkIcon
                    color={user?.aadhaarLinked ? "success" : "action"}
                  />
                </ListItemIcon>
                <ListItemText
                  primary={
                    <Typography fontWeight={600}>Aadhaar Number</Typography>
                  }
                  secondary={
                    user?.aadhaarLinked
                      ? "Verified and linked"
                      : "Not linked - Required for most schemes"
                  }
                />
                <GramButton
                  variant={user?.aadhaarLinked ? "tonal" : "primary"}
                  size="small"
                >
              ...
              <ListItemButton sx={{ p: 3 }}>
                <ListItemIcon>
                  <LinkIcon color={user?.bankLinked ? "success" : "action"} />
                </ListItemIcon>
                <ListItemText
                  primary={
                    <Typography fontWeight={600}>Bank Account</Typography>
                  }
                  secondary={
                    user?.bankLinked
                      ? "HDFC Bank ending in 1234"
                      : "Not linked - Required for DBT"
                  }
                />
                <GramButton
                  variant={user?.bankLinked ? "tonal" : "primary"}
                  size="small"
                >
